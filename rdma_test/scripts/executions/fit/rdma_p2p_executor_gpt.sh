...
./build/rdma_p2p_gpt 2>&1 | tee ./logs/rdma_server_gpt.log & pid0=$!
./build/rdma_p2p_gpt 14.14.15.5 2>&1 | tee ./logs/rdma_client_gpt.log & pid1=$!
...
# ib_write_bw -d mlx5_3 -p 10121 14.14.15.5 & pid1=$!
